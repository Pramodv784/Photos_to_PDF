...
class UserSelectImageAdapter(val list:List<GridViewItem>, val context:Context) :RecyclerView.Adapter<UserSelectImageAdapter.ViewHolder>() {
   lateinit var itemClick:(item:GridViewItem) -> Unit
    ...
    override fun onCreateViewHolder(
        ...
        val binding = SelectedItemViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
   ...
   inner class ViewHolder(val binding:SelectedItemViewBinding):RecyclerView.ViewHolder(binding.root)
}